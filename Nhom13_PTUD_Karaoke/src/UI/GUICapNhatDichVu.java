...
public class GUICapNhatDichVu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtMaDichVu.setPreferredSize(new java.awt.Dimension(64, 26));

        txtTenDichVu.setPreferredSize(new java.awt.Dimension(64, 26));
        ...
        txtGiaBan.setPreferredSize(new java.awt.Dimension(64, 26));
        ...
        txtSoLuong.setPreferredSize(new java.awt.Dimension(64, 26));

        lblGiaBan.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        lblGiaBan.setText("Giá bán:");

        txtDonViTinh.setPreferredSize(new java.awt.Dimension(64, 26));
        ...
        lblLoaiDichVu.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        ...
        pnlThongTinDichVuLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pnlThongTinDichVuLayout.createSequentialGroup()
                ...
                .addGroup(pnlThongTinDichVuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(cboLoaiDV, 0, 120, Short.MAX_VALUE))
                .addGap(26, 26, 26)
                .addGroup(pnlThongTinDichVuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(pnlThongTinDichVuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlThongTinDichVuLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtDonViTinh, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(71, 71, 71))
                    .addGroup(pnlThongTinDichVuLayout.createSequentialGroup()
                ...
                .addGroup(pnlThongTinDichVuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(pnlThongTinDichVuLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlThongTinDichVuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlThongTinDichVuLayout.createSequentialGroup()
                                .addGroup(pnlThongTinDichVuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtMaDichVu, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(lblMaDichVu))
                            ...
                            .addGroup(pnlThongTinDichVuLayout.createSequentialGroup()
                                ...
                                .addGroup(pnlThongTinDichVuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(lblTenDichVu)
                                    .addComponent(txtTenDichVu, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(lblSoLuong)
                        ...
                        .addGroup(pnlThongTinDichVuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(lblGiaBan)
                            .addComponent(lblLoaiDichVu)
                            .addComponent(cboLoaiDV, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(29, 29, 29))
        );
        ...
        tblDanhSachDichVu.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã dịch vụ", "Tên dịch vụ", "Số lượng", "Giá bán", "Đơn vị tính", "Trạng thái dịch vụ", "Loại dịch vụ"
            }
        ) {
        ...
        pnlDanhSachDichVuLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlDanhSachDichVuLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(scrDanhSachDichVu, javax.swing.GroupLayout.PREFERRED_SIZE, 1458, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(22, 22, 22))
        );
    ...
    private void btnCapNhatThongTinDichVuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCapNhatThongTinDichVuActionPerformed
        ...
        if (txtMaDichVu.getText().equals("") ||txtTenDichVu.getText().equals("")||txtSoLuong.getText().equals("")||txtGiaBan.getText().equals("")||txtDonViTinh.getText().equals("")||radCon.getText().equals("")&&radHet.getText().equals("")) {
			...
			Boolean trangThaiDV = true;
                        LoaiDichVu loaiDV = new LoaiDichVu(cboLoaiDV.getSelectedItem().toString());
			...
			DichVu x = new DichVu(maDV, tenDV, soLuong, giaBan,donViTinh,trangThaiDV,loaiDV);
...
//        }
        ...
        private void themDuLieuComboBoxLDV() throws SQLException{
        ArrayList<LoaiDichVu> dsLDV = ldv_dao.layDanhSachLoaiDichVu();
		for(LoaiDichVu x : dsLDV)
		{
			cboLoaiDV.addItem(x.getMaLoaiDV());                        
		}
    }
...
//    int row;
	...
	public void docDuLieuTuDataVaoTable() throws SQLException 
	{
		...
		for(DichVu x : listdv)
		{
                    ...
                    dftbl.addRow(new Object[] {x.getMaDV(),x.getTenDV(),x.getSoLuong(),x.getGiaBan(),x.getDonViTinh(),trangThai,x.getLoaiDV().getMaLoaiDV()});
		}
        }
